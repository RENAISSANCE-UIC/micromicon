...
#' This is a legacy function; new code should use gff_gateway methods.
#'
#' @param gff_path Path to GFF3 file
#' @param drop_invalid Logical; drop invalid rows (default TRUE)
#' @param verbose Logical; print messages (default TRUE)
#' @return Path to cleaned temporary GFF3 file
#' @keywords internal
...
#' Harmonize GFF seqlevels to FASTA headers (LEGACY)
#'
#' @description
#' Attempts multiple strategies to harmonize GFF seqlevels with FASTA headers.
#' This is a legacy function; new code should use import_gff_fasta use case.
#'
#' Attempts, seriatim:
...
#'
#' @param genome_obj Legacy genome object with gff, fa, and seqnames components
#' @param use_length_fallback Logical; enable length-based fallback (default FALSE)
#' @return Modified genome_obj with harmonized GFF seqlevels
#' @keywords internal
